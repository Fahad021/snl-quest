...
def read_isone_data(fpath, year, month, nodeid):
    ...
    if year < 2018 and year == 2017 and month == 12 or year >= 2018:
    ...
    try:
        if year > 2014 and year == 2015 and month < 4 or year <= 2014:
            ...
            hours = list(range(len(dataF_mileage_file.index)//900))
